...
import housePng from 'assets/about/casa.png';
import pastaOnePng from 'assets/about/massa1.png';
import pastaTwoPng from 'assets/about/massa2.png';

const images = [pastaOnePng, pastaTwoPng];
  ...
  return (
    <section>
      ...
      <div className={styles.aboutUs}>
        <img src={housePng} alt='Casa Aluroni' />
